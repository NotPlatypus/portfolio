...
if (!lastTypeTime) lastTypeTime = currentTime - 1000; 
...
console.log('%c⚡ Optimized for all devices and refresh rates (60-260Hz)', 'color: #4facfe; font-size: 12px;');
// === DEBOUNCE UTILITY === 
...
// Replace old observer with fast one
...
console.log('%c🚀 Ultra-Optimized Portfolio!', 'color: #6366f1; font-size: 18px; font-weight: bold;');
console.log('%c⚡ Debounced scroll • Throttled events • Lazy loading', 'color: #10b981; font-size: 12px;');
console.log('%c📱 Mobile-first • 60-360Hz optimized', 'color: #4facfe; font-size: 12px;');
